                    ...
                    ZStack {
                        ...
                        VStack(spacing: 0) {
                            ...
                            Rectangle()
                                .fill(Color.primary)
                                .colorInvert()
                                .frame(width: self.meterWidth, height: (geometry.size.height - self.verticalPadding) - CGFloat(self.fractionOfFullMeter) * (geometry.size.height - self.verticalPadding), alignment: .center)
                            
                            // "Fill" for progress meter; stationary
                            Rectangle()
                                .fill(LinearGradient(gradient: Gradient(colors: [Color.red, self.endColor]),
                                                     startPoint: .bottom,
                                                     endPoint: .top))
                                .frame(width: self.meterWidth, height: CGFloat(self.fractionOfFullMeter) * (geometry.size.height - self.verticalPadding), alignment: .center)
                        ...
                        Rectangle()
                            .fill(Color.primary)
                            .colorInvert()
                            .frame(width: self.meterWidth, height: geometry.size.height - self.verticalPadding, alignment: .center)
                            .offset(self.progressMeterOffset)
                            .onAppear(perform: {
                                withAnimation(Animation.easeIn(duration: 4.0)) {
                                    // Offset is moves the opaque rectangle up
                                    self.progressMeterOffset = CGSize(width: 0, height: -1 * (geometry.size.height - self.verticalPadding))
                                }
                            })
                        ...
                        Rectangle()
                            ...
                            .frame(width: self.meterWidth + self.borderWidth, height: geometry.size.height - self.verticalPadding + self.borderWidth, alignment: .center)
                            .overlay(
                                Rectangle()
